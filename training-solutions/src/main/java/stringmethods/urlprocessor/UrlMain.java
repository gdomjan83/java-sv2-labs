...
public class UrlMain {
    public static void main(String[] args) {
        UrlManager urlManager = new UrlManager("https://earthquake.usgs.gov:3050/fdsnws/event/1/query?format=geojson&starttime=2014-01-01&endtime=2014-01-02");
        ...
        System.out.println("Has query: " + urlManager.hasProperty("starttime"));
