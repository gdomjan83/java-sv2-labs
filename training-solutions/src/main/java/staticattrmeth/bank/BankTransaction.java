...
public class BankTransaction {
    ...
    public BankTransaction(long transactionValue) {
        ...
        updateMinMaxValues(transactionValue);
    }

    public static void initTheDay(){
        currentMaxValue = MAX_TRANSACTION_VALUE;
        currentMinValue = MIN_TRANSACTION_VALUE;
    ...
    private void updateMinMaxValues(long transactionValue) {
